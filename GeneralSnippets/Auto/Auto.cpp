...
namespace Auto_Examples {
    ...
    static void test_01() {
        ...
        //n.value = 123;  // Attribute zur Laufzeit

        //// TypeScript

        auto z = 123.456f;  // Type Deduction // Typableitung

        123;   // C/C++:  Konstanten ===> Datentyp
    ...
    void testSeminar()
    {
        auto result = tueWas<>(true, 123ll,  123ll);
    }

    // C/C++: eingebautes Regelwerk für elementare Datentypen: a + b
